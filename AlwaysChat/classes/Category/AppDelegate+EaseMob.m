...
#warning SDK注册 APNS文件的名字, 需要与后台上传证书时的名字一一对应
    ...
    if (![self isSpecifyServer]) {
        [[EaseMob sharedInstance] registerSDKWithAppKey:@"418083501#alwayschat"
...
{
    [LOGIN_USER didReceiveMessage:message];
}
...
{
    [LOGIN_USER didReceiveOfflineMessages:offlineMessages];
}
